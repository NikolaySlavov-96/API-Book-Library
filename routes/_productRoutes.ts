...
product.post('/',
    ...
    body('publishedYear').optional({ nullable: true }).isInt({ min: 0, max: 3000, })
...
product.delete('/status/:productId',
    isAuthenticated(),
    productStatusController.deleteProductStatus
);
