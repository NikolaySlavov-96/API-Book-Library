...
export type IProductStatusRecord = TProductStatusRow;

export type IProductStatusCreateInput = Pick<TProductStatusRow, 'userId' | 'productId' | 'statusId'>;
...
export interface IProductStatusRepository {
    ...
    create(input: IProductStatusCreateInput): Promise<IProductStatusRecord>;
