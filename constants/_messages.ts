...
const messages: IMessageType = {
    ...
    SUCCESSFULLY_ADDED_PRODUCT_IN_COLLECTION: {
        message: 'Successfully added book in your collection',
        messageCode: 'book-0003',
    },
    SUCCESSFULLY_REMOVED_PRODUCT_FROM_COLLECTION: {
        message: 'Successfully removed book from your collection',
