...
// Centralized logger for the API project.
// All `console.*` calls in the codebase should go through this helper.
// Keep this as the ONLY file allowed to call console.* directly.
...
const ACTIVE_LEVEL: LogLevel = envLevel in LEVEL_ORDER ? envLevel : isProd ? 'info' : 'debug';
