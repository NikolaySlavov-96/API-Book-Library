CREATE TABLE
    user_book_purchase (
        ...
        CONSTRAINT fk_user_book_purchase_user FOREIGN KEY (user_id) REFERENCES account (id),
        CONSTRAINT fk_user_book_purchase_book FOREIGN KEY (book_id) REFERENCES book (id)
    );
